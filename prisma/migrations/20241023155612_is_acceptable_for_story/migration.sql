...
INSERT INTO "new_Story" ("authorId", "createdAt", "description", "embedding", "id", "title", "updatedAt", "views") SELECT "authorId", "createdAt", "description", "embedding", "id", "title", "updatedAt", "views" FROM "Story";
DROP TABLE "Story";
