	...
	return (
		<div className="container mx-auto px-4 py-8">
			...
			<div className="space-y-4">
				...
				<ol className="list-none space-y-4 counter-reset-1">
					<li className="counter-increment-1">
						<h2 className="text-2xl font-bold mt-4 mb-2"><span className="counter-result-1" />. Minimum Age</h2>
					...
					<li className="counter-increment-1">
						<h2 className="text-2xl font-bold mt-4 mb-2"><span className="counter-result-1" />. Your Account with Us</h2>
						<p>
					...
					<li className="counter-increment-1">
						<h2 className="text-2xl font-bold mt-4 mb-2"><span className="counter-result-1" />. Creating an Account</h2>
						<ol className="list-none mt-2 ml-6 space-y-2 counter-reset-2">
							<li className="counter-increment-2">
								<span className="counter-result-1" />.<span className="counter-result-2" />. Only individual persons can register to the Platform. When registering on our Platform, you must provide accurate information about yourself. You may not use false information or impersonate another person or company through your Account. Your account is not transferable and so you may not transfer your Account to anyone else. It is your sole responsibility to ensure that the contact information in your Account is current and accurate. Changes to your contact information can be made through the Platform.
							</li>
							<li className="counter-increment-2">
						<span className="counter-result-1" />.<span className="counter-result-2" />. You will be asked to choose a username for your profile. Do not choose a username that is in any way offensive, vulgar, or infringes someone's intellectual property rights.
						</li>
						<li className="counter-increment-2">
						<span className="counter-result-1" />.<span className="counter-result-2" />. You are solely responsible for any activity on your Account, so it is important that you keep your Account password secure. You must not let anyone else access your Account or do anything else that might jeopardize the security of your Account. In the event you become aware of or reasonably suspect any breach of security, including, without limitation any loss, theft, or other unauthorized access to your Account, you must immediately notify us of such breach via our contact form at https://www.{CONFIG.DOMAIN}/contact. We will not be liable for your losses caused by any unauthorized use of your Account.
						</li>
						<li className="counter-increment-2">
						<span className="counter-result-1" />.<span className="counter-result-2" />. We have no control over your actions or transactions made using the Platform. With that in mind, we will have no liability to you or to any third-party for any claims or damages that may arise as a result of any actions or transactions that you engage in while using the Platform.
						</li>
						<li className="counter-increment-2">
						<span className="counter-result-1" />.<span className="counter-result-2" />. We reserve the right to deny your access to the Services immediately and with or without cause, including without limitation if we believe that you are in breach of these Terms for any reason whatsoever.
						</li>
						</ol>
					<li className="counter-increment-1">
						<ol className="list-none mt-2 ml-6 space-y-2 counter-reset-2">
							<h2 className="text-2xl font-bold mt-4 mb-2"><span className="counter-result-1" />. Your Use of the Services</h2>
						<li className="counter-increment-2">
							<span className="counter-result-1" />.<span className="counter-result-2" />. License. {CONFIG.SITENAME} hereby grants you, subject to the terms and conditions of these Terms, a non-exclusive, non-transferable personal license to:
							</li>
							<ol className="list-none mt-2 ml-6 space-y-1 counter-reset-3">
								<li className="counter-increment-3"><span className="counter-result-1" />.<span className="counter-result-2" />.<span className="counter-result-3" /> Use the Platform for your own personal use.</li>
							</ol>
						</ol>
					</li>
					</li>
					<h2 className="text-2xl font-bold mt-4 mb-2"><span className="counter-result-1" />. Our Rights in the Services</h2>
					<li className="counter-increment-1">
						<p>
					...
					<li>
						<h2 className="text-2xl font-bold mt-4 mb-2">Notices and Messages</h2>
						<p>
							We will provide notices and messages to you either via the services, or sent to the contact information you provided us when registering for the Platform, and you agree to ensure that this contact information is kept up to date from time to time.
						</p>
					</li>
					<li>
						...
						<ul>
							<li>take any action that infringes or violates other people's rights, violates any law, or breaches any contract or legal duty you have toward anyone.</li>
							<li>defame, stalk, bully, abuse, threaten, harass, abuse, intimidate, harm another person or engage in any other predatory behavior, including sending unwelcomed communications to others, or incite others to commit violent acts or any of the aforementioned;</li>
							<li>be disrespectful when you communicate or interact with others;</li>
							<li>share other users' or third party's information without their express written consent;</li>
							...
							<li>engage in “framing,” or in “mirroring,” or otherwise simulate the appearance or function of the Services in any way;</li>
							<li>attempt to or actually override any security component included in or underlying the Services;</li>
							<li>interfere or disrupt the Services, including, but not limited to any servers or networks connected to the Services, or the underlying software.</li>
						</ul>
						<p>
						...
						<ul>
							...
							<li>immediate, temporary or permanent removal of any of Your Content;</li>
							<li>issuing of a warning to you;</li>
							<li>taking of legal action against you including proceedings for reimbursement of all costs (including, but not limited to, reasonable administrative and legal costs) resulting from the breach;</li>
							<li>disclosure of such information to law enforcement authorities as we reasonably feel is necessary, or otherwise may be obligated to disclose.</li>
							<li>investigate any suspected breach of the Terms. During such investigation we may temporarily withdraw your right to use our Services, pause your subscription, restrict right to use Services (including, without limitation, restrict the visibility of Your Content on our Platform, or pause or cancel your subscribers' subscriptions on Tebex or other third party providers), or remove Your Content without notice to you.</li>
						</ul>
						<p>
